...
export type MutationAddItemsToPlaylistArgs = {
  input?: InputMaybe<AddItemsToPlaylistInput>;
};
...
export type MutationResolvers<ContextType = DataSourceContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  addItemsToPlaylist?: Resolver<ResolversTypes['AddItemsToPlaylistPayload'], ParentType, ContextType, Partial<MutationAddItemsToPlaylistArgs>>;
};
